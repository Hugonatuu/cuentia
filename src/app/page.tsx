    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section id="how-it-works" className="py-20 bg-card overflow-hidden relative">
          <div className="absolute top-0 left-0 w-72 h-72 bg-blue-300/50 rounded-full mix-blend-multiply filter blur-xl opacity-75 animate-blob"></div>
          <div className="absolute top-0 right-0 w-72 h-72 bg-pink-300/50 rounded-full mix-blend-multiply filter blur-xl opacity-75 animate-blob animation-delay-2000"></div>
