        ...
        <section id="how-it-works" className="py-20 bg-card overflow-hidden">
          <div className="container mx-auto px-4">
            ...
            <div className="relative grid md:grid-cols-2 gap-16 items-center mt-20">
              <div className="z-10 text-center md:text-left animate-in fade-in slide-in-from-left-16 duration-500">
                <Card className="inline-block p-8 bg-background shadow-xl border-2 border-primary/20 relative overflow-hidden transition-transform duration-300 hover:scale-105">
              ...
              <div className="relative h-[400px] flex items-center justify-center animate-in fade-in slide-in-from-right-16 duration-500">
            ...
            <div className="relative grid md:grid-cols-1 gap-16 items-center mt-20 animate-in fade-in slide-in-from-bottom-8 duration-500">
             ...
             <div className="relative grid md:grid-cols-1 gap-16 items-center mt-20 animate-in fade-in slide-in-from-bottom-8 duration-500 delay-200">
              <div className="z-10 text-center md:col-span-1">
                <Card className="inline-block p-8 bg-background shadow-xl border-2 border-primary/20 relative overflow-hidden transition-transform duration-300 hover:scale-105">
